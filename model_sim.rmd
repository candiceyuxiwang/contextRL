...
library(cmdstanr)
Bayes_SMEP_cond_mod <- cmdstan_model("Bayes_SMEP_cond.stan")

# MCMC
sim_Bayes_SMEP <- Bayes_SMEP_cond_mod$sample(
  data = sim_data_cond_list, 
  chains = 2, 
  parallel_chains = 2,
  iter_warmup = 100,          # number of warmup iterations per chain
  iter_sampling = 100
)
sim_Bayes_SMEP$print(c("beta_mu","beta_sigma","phi_mu","phi_sigma","persev_mu","persev_sigma"))
sim_Bayes_SMEP$print(c("beta_diff","phi_diff","perserv_diff"))
```
