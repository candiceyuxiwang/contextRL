...
traceplot(fit_Bayes_SMEP_cond, pars = c("beta_mu","beta_sigma","phi_mu","phi_sigma","persev_mu","persev_sigma"))
...
There seems to be both a significant difference in beta and phi hyperparameters, where people in the imperative condition tended to place more weight on expected value when making bandit choices (beta), and those in the interrogative condition valued resolving uncertainty more (directed exploration, phi). However, compared to the values from Chakroun et al., these beta_mu's are really low, persev_mu rather large.
