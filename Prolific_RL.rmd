...
We can also try fitting a two-condition version of the delta learning model:
...
learn_fit_delta_SMEP_cond <- rstan::stan(
  file = "delta_SMEP_cond.stan",  # Stan program
  data = learn_data_list_delta,    # named list of data
  chains = 4,             # number of Markov chains
  warmup = 200,          # number of warmup iterations per chain
...
print(learn_fit_delta_SMEP_cond, pars = c("eta_mu","eta_sigma","alpha_mu", "alpha_sigma", "beta_mu","phi_mu","persev_mu","alpha_diff","beta_diff","phi_diff","persev_diff"))
...
Need to think about how to set the reference group in the multinomial logistic regression, but it does seem like the interrogative group made more directed exploration choices to resolve uncertainty compared to the imperative group, and the imperative group made more exploitation choices to maximize points gained.
