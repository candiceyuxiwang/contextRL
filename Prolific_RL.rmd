...
beta_mu_diff %>%
  ...
  ylab("")+
  ggtitle("Group Difference (Imperative - Interrogative)\nParameter Estimate Posterior Distributions")+
  theme_allie()
...
Imp_sub_choice_class %>%
  ...
  geom_line(aes(y = V1), color = door_key[1])+
  geom_line(aes(y = V2), color = door_key[2])+
  geom_line(aes(y = V3), color = door_key[3])+
  geom_line(aes(y = V4), color = door_key[4])+
  theme_allie()+
  xlab("Trial #")+
  ylab("Expected Value")+
  ggtitle("Model-Derived Expected Value (Interrogative)")+
  ylim(0,100)

# plot trial by trial estimated uncertainty
Imp_sub_choice_class %>%
  ggplot(aes(x = learn_trial_n))+
  geom_line(aes(y = uncertainty_1), color = door_key[1])+
  geom_line(aes(y = uncertainty_2), color = door_key[2])+
  geom_line(aes(y = uncertainty_3), color = door_key[3])+
  geom_line(aes(y = uncertainty_4), color = door_key[4])+
  theme_allie()+
  xlab("Trial #")+
  ylab("Estimated Uncertainty")+
  ggtitle("Model-Derived Estimated Uncertainty (Interrogative)")+
  ylim(0,15)
