---
title: "replication_sample_truncated"
author: "Candice Wang"
date: "9/2/2022"
...
saveRDS(bayes_data_list_1, "/Volumes/main2/studies/Context_RL/Analysis/trunc_rep_learn_data_list_bayes.RData")
...
Same conclusions (except that the difference in directed exploration is now significant with only the first 50 trials, whereas it was trending with the full replication sample), and similar effect sizes.
