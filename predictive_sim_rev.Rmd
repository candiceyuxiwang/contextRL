...
sub_params_bayes_2 <- function(beta_mu, beta_mu_diff, beta_sigma, phi_mu, phi_mu_diff, phi_sigma, persev_mu, persev_mu_diff, persev_sigma){
  ...
  betas <- c(rnorm(Nsub/2, beta_mu + beta_mu_diff, beta_sigma), rnorm(Nsub/2, beta_mu - beta_mu_diff, beta_sigma))
  phis <- c(rnorm(Nsub/2, phi_mu + phi_mu_diff, phi_sigma), rnorm(Nsub/2, phi_mu - phi_mu_diff, phi_sigma))
  persevs <- c(rnorm(Nsub/2, persev_mu + persev_mu_diff, persev_sigma), rnorm(Nsub/2, persev_mu - persev_mu_diff, persev_sigma))
...
bayes_SMEP_post_pars <- sub_params_bayes_2(beta_mu=rnorm(1,0.06,0.005), beta_mu_diff=rnorm(1,0.03,0.01), beta_sigma= rnorm(1,0.04,0.005), 
                                   ...
                                   persev_mu = rnorm(1,0.44,0.07), persev_mu_diff = rnorm(1,-0.13,0.15), persev_sigma = rnorm(2,0.95,0.06))
