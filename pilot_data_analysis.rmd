...
points(reward_schedule$V1, col=door_key[2],pch=20)
points(reward_schedule$V2, col=door_key[1],pch=20)
points(reward_schedule$V3, col=door_key[4],pch=20)
points(reward_schedule$V4, col=door_key[3],pch=20)
...
learn_data %>%
  ...
  geom_point(aes(color = choice_type))
```
